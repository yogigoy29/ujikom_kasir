...
$sql1 = "SELECT COUNT(*) as total FROM pelanggan";
...
$sql = "SELECT pelanggan.*, toko.nama_toko FROM pelanggan
        INNER JOIN toko ON pelanggan.toko_id = toko.toko_id
...
<div class="pagination-container">
    <ul class="pagination justify-content-center">
        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
            <li class="page-item <?php if ($i == $page) echo 'active'; ?>"><a class="page-link" href="pelanggan.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php endfor; ?>
    </ul>
    </div>
    </div>
