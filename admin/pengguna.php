...
$sql = "SELECT user.*, toko.nama_toko FROM user
        INNER JOIN toko ON user.toko_id = toko.toko_id
                        ...
                        <div class="table-container">
                            <div class="container" style="width:100%; ">
                                <div class="table-container d-flex" style="width:150%; position:absolute; left:150px;">
                                    <div class="content shadow p-3 mb-5 bg-body-tertiary rounded" style="width:200%;height: 400px;; background-color:white;">
                                        <div class="container d-flex" style="position:relative; width:100%;">
                                             <table class="table" style="width:100%;height: 100%">
                                                ...
                                                while ($row = $result->fetch_assoc()){  $i++;
                                                    ...
                                                    echo "<td>" . $row["role"] . "</td>";                                                    
                                                    echo "<td>
                                                <a href='Edit/edit_pengguna.php?id=" . $row['user_id'] . " 'class='btn btn-sm' style='background-color:#FE7A36; color:#fff'>Edit</a>
...
<div class="pagination-container">
    <ul class="pagination justify-content-center">
        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
            <li class="page-item <?php if ($i == $page) echo 'active'; ?>"><a class="page-link" href="pengguna.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php endfor; ?>
    </ul>
    </div>
    </div>
