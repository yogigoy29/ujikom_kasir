...
session_start();
$sql="SELECT produk.*, produk_kategori.nama_kategori, toko.nama_toko FROM produk INNER JOIN produk_kategori ON produk.kategori_id=produk_kategori.id INNER JOIN toko ON produk.toko_id=toko.toko_id";
...
<div class="pagination-container">
    <ul class="pagination justify-content-center">
        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
            <li class="page-item <?php if ($i == $page) echo 'active'; ?>"><a class="page-link" href="list_produk.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php endfor; ?>
    </ul>
    </div>
                                     </div>
